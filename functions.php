...
function pointb_styles() {
	wp_enqueue_style( 'pointb-base', get_template_directory_uri() . '/css/base.css' );
	wp_enqueue_style( 'pointb-icons', get_template_directory_uri().'/css/font-awesome.min.css' );
	wp_enqueue_style( 'pointb-fonts', pointb_fonts_url() );
	wp_enqueue_style( 'pointb-style', get_stylesheet_uri() );
}
...
function pointb_continue_reading_link() {
	return ' <p class="more-link"><a href="'. esc_url( get_permalink() ) . '">' . __( 'Lire la suite <span class="meta-nav">&rarr;</span>', 'pointb' ) . '</a></p>';
}

/* Adds a pretty "Continue Reading" link to defined excerpts. ---------------*/
function pointb_custom_excerpt( $output ) {
	if ( has_excerpt() && ! is_attachment() ) {
		$output .= '&hellip; ' . pointb_continue_reading_link();
	}
	return $output;
}
...
/* Customizer support. ------------------------------------------------------*/
require pointb_PATH . '/inc/customizer.php';

/* Custom template tags for this theme. -------------------------------------*/
require pointb_PATH . '/inc/template-tags.php';
